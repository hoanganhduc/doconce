        ...
        def bootstrap_navigation(pn, prev_part_filename, next_part_filename):
            ...
            if '--pagination' in sys.argv:
                ...
                if pn > 0:
                    text += r"""
  <li class="page-item">
    <a class="page-link" style="text-decoration:none;" href="%s">&larr; Prev</a>
  </li>
  </ul>
""" % prev_part_filename
                if pn < len(parts)-1:
                    text += r""" <ul class="pagination pagination-lg justify-content-end">
  <li class="page-item">
    <a class="page-link" style="text-decoration:none;" href="%s">Next &rarr;</a>
  </li>
""" % next_part_filename
                text += '</ul>\n'
            return text
